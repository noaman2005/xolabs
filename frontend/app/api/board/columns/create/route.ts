...
import { assertWorkspaceMember, createColumn, getBoard } from '../../../../../lib/features/board/dynamodb'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const column = await createColumn({ workspaceId, channelId, title: title.trim() })
