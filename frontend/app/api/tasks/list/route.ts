...
import { getTasks, assertWorkspaceMember } from '../../../../lib/features/tasks/dynamodb'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const tasks = await getTasks(workspaceId, channelId)
    tasks.forEach((task: Task) => taskStore.upsertTask(task))
